...
import com.newekaratasi.SingleUploadBroadcastReceiver;
...
public class EditProfile_Activity extends AppCompatActivity implements OnPageChangeListener, OnLoadCompleteListener,
    ...
    public void EditProfile(){
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        com.newekaratasi.ApiServiceEditProfile service = retrofit.create(com.newekaratasi.ApiServiceEditProfile.class);

...
//                    ConfirmAgent();
    ...
    public void ConfirmAgent(){
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        com.newekaratasi.ApiServiceConfirm service = retrofit.create(com.newekaratasi.ApiServiceConfirm.class);
    ...
    public void SaveData(){
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .addConverterFactory(GsonConverterFactory.create(gson))
                .build();
        com.newekaratasi.ApiService service = retrofit.create(com.newekaratasi.ApiService.class);
